...
<head>
	...
	<title>美娱美乐www.lecc.cc--戏剧曲艺--${c.title }</title>
		...
		<div id="qgcontain">
			<dl id="qgsublist">
				...
				<c:forEach items="${list}" var="ci" varStatus="i">
					...
					<a class="qgsuba1" href="${pageContext.request.contextPath}/xijuquyi/${ci.id}-${param.city_id}"><img src="${ci.img_url }" alt="${ci.name }" width="150px" height="200px"/></a>
					<div class="ctitlee"><a class="qgsuba2" href="${pageContext.request.contextPath}/xijuquyi/${ci.id}-${param.city_id}" title="${ci.name }">
				...
				<!-- 	<div class="descr">
					...
					<div class="qgsbjc">${ci.site_name }</div>
				...
				<div class="Pagination">
					 <jsp:include page="../pagenation_util.jsp">
		 				<jsp:param  name="url" value="${pageContext.request.contextPath}/xijuquyi-${c.id}-${param.city_id}"/>
	 				</jsp:include>
				</div>
		  </div>
