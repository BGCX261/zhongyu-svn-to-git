...
<body>
			...
			<div id="myfavout" class="clearboth">
				<div id="myfavl">
					...
					<ul id="myfavsort" class="clearboth">
						<li>排序：</li>
						<li><a href="" id="sort1" class="current">按推荐先后</a></li>
						<li><a href="" id="sort2">按演出时间先后</a></li>
					</ul>
					<ul id="myfavlist">
					</ul>
				...
				<div id="myfavr">
					...
					<div id="wdsc">
						<div id="wdscimg">
							<a href=""><img src="${pageContext.request.contextPath}/public/images/scpic.jpg" alt="" /></a>
						</div>
						<p>时间：2012.5.8  19:00</p>
						<p>地点：海淀剧院</p>
					</div>
					<div class="btntag">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/public/js/recommend.js"></script>
