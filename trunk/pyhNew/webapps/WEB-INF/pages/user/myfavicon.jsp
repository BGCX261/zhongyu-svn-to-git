...
<body>
			...
			<div id="myfavout" class="clearboth">
				<div id="myfavl">
					...
					<ul id="myfavsort" class="clearboth">
						<li>排序：</li>
						<li><a href="" id="sort1" class="current">按收藏先后</a></li>
				...
				<div id="myfavr">
					...
					<h4>美娱美乐网意见反馈</h4>
					<p class="fkyj">欢迎使美娱美乐网并提出宝贵建议。</p>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/public/js/collect.js"></script>
