...
<body>
	...
	<div id="myfavcon">
		<div id="myfavcontain">
			<div id="myfavout" class="clearboth">
				...
				<div id="myfavr">
					<div id="usrinfo">
						<div id="head"><a href="" title="">
						<c:choose>
							<c:when test="${empty user.wholeImgPath}">
								<img src="${pageContext.request.contextPath}/public/images/head_default3.png" alt="${user.user_nick}"/>
							</c:when>
							<c:otherwise>
								<img src="${user.wholeImgPath}" alt="${user.user_nick}"/>
							</c:otherwise>
							</c:choose>
						</a></div>
						<div id="uinfo">
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/public/js/letter.js"></script>
