...
<head>
	...
	<title>美娱美乐www.lecc.cc--身边有戏--${commonInfo.name}</title>
...
<div class="tanchuang">
	...
	<div class="tanchuang">
		<div class="bgwhite">
			...
			<form action="">
				...
				<div class="popin">
					<div class="popinl clearboth"><img src="${pageContext.request.contextPath}/public/images/face_smile.png" alt="" /><input type="checkbox" name="tshipl" id="tshipl" /><label for="tshipl">同时推荐到都在看</label></div>
					<div class="popinr">
						<div class="zishu clearboth">
							<div class="zisshu">还可以输入<span class="zinumber">500</span>字&nbsp;</div>
	...
	<div id="qgcontainer" class="qgcontainer">
		<div id="qgcontain">
			<div id="daohang">
				<a href="">票友会</a> &gt; <a href="${pageContext.request.contextPath}/main.do?city_id=${commonInfo.city_id}">${commonInfo.city_name }</a> &gt; <a href="${pageContext.request.contextPath}/result/main.do?city_id=${commonInfo.city_id}&show_type=${commonInfo.show_type}">${commonInfo.type_name }</a> &gt; ${commonInfo.name}
			</div>
			<div id="xqdetail">
				...
				<div id="jutixx">
					<div id="xxcontain" class="clearboth">
						...
						<div id="xxcontainr">
							...
							<ul id="cgxxs">
								<li><span class="attr">时间：</span>${commonInfo.year}年${commonInfo.month}月${commonInfo.day}日(${commonInfo.week}) ${commonInfo.show_time}</li>
							...
							<ul class="clearboth" id="shareto">
								<li>分享到：</li>
								<li><a class="sianwb" href="http://service.weibo.com/share/share.php?title=<%=myShowName %>&url=http://www.lecc.cc/result/resultDetail.do?id=${commonInfo.id }&appkey=2268730460&pic=<%=pic%>" target="_blank">新浪微博</a></li>
								<li><a href="http://www.douban.com/recommend/?url=http://www.lecc.cc/result/resultDetail.do?id=${commonInfo.id }&amp;title=<%=myShowName %>&image=<%=pic%>" target="_blank" class="doubans">豆瓣</a></li>
								<li><a href="http://v.t.qq.com/share/share.php?title=<%=myShowName %>&amp;url=http://www.lecc.cc/result/resultDetail.do?id=${commonInfo.id }&amp;site=http://www.lecc.cc/&amp;pic=<%=pic%>" target="_blank" class="txwb">腾讯微博</a></li>
							</ul>
						</div>
					</div>
