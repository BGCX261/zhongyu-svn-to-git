...
<head>
	...
	<title>美娱美乐www.lecc.cc--身边有戏--北京--首页</title>
		...
		<ul id="sbyxlists" class="clearboth">
				...
				<div class="picbgs slide2">
					<div class="slide">
						<div class="slides_container">
							<div>
								<a href="${pageContext.request.contextPath}/sbyx-1820-1">
			...
			<li class="clearboth">
				...
				<div class="picbgs slide1">
					<div class="slide">
						<div class="slides_container">
							<div>
								<a href="${pageContext.request.contextPath}/sbyx-1821-1">
									<img src="${pageContext.request.contextPath}/public/images/juchang1.jpg" alt="" />
								</a>
							</div>
							<div>
			...
			<li class="clearboth">
				...
				<div class="picbgs slide2">
					<div class="slide">
						<div>
							<a href="${pageContext.request.contextPath}/sbyx-1822-1">
			...
			<li class="clearboth">
				...
				<div class="picbgs slide3">
					<div class="slide">
						<div>
							<a href="${pageContext.request.contextPath}/sbyx-1823-1">
			...
			<li class="clearboth">
				...
				<div class="picbgs slide1">
					<div class="slide">
						<div>
							<a href="${pageContext.request.contextPath}/sbyx-1824-1">
			...
			<li class="clearboth">
				...
				<div class="picbgs slide4">
					<div class="slide">
						<div>
							<a href="${pageContext.request.contextPath}/sbyx-1825-1">
			...
			<li class="clearboth">
				...
				<div class="picbgs slide2">
					<div class="slide">
						<div>
							<a href="${pageContext.request.contextPath}/sbyx-1826-1">
			...
			<li class="clearboth">
				...
				<div class="picbgs slide3">
					<div class="slide">
						<div>
							<a href="${pageContext.request.contextPath}/sbyx-1827-1">
			...
			<li class="clearboth">
				...
				<div class="picbgs slide1">
					<div class="slide">
						<div>
							<a href="${pageContext.request.contextPath}/sbyx-1828-1">
			...
			<li class="clearboth">
				...
				<div class="picbgs slide4">
					<div class="slide">
						<div>
							<a href="${pageContext.request.contextPath}/sbyx-1829-1">
