...
<body>
	...
	<div id="sbyxnavcon">
		<ul id="sbyxnav" class="clearboth">
			<li><a href="${pageContext.request.contextPath}/sbyx/main.do?category_id=${category.parent_id}">首页</a></li>
			
			<c:forEach items="${categoryList}" var="cate">
				<li><a href="${pageContext.request.contextPath}/sbyx/sbyxquyulist.do?category_id=${cate.id}" <c:if test="${cate.id==category.id}">class="current"</c:if>>${cate.title}</a></li>
			</c:forEach>
		</ul>
	</div>
	<div id="slides">
		<div class="slides_container">
			<a href=""><img src="${pageContext.request.contextPath}/public/images/slider1.jpg" alt="" /></a>
			<a href=""><img src="${pageContext.request.contextPath}/public/images/slider2.jpg" alt="" /></a>
			<a href=""><img src="${pageContext.request.contextPath}/public/images/slider3.jpg" alt="" /></a>
			<a href=""><img src="${pageContext.request.contextPath}/public/images/slider4.jpg" alt="" /></a>
		</div>
	...
	<div id="sbyxcontainer">
		<dl id="showlist">
			...
			<c:forEach items="${commonList}" var="commonInfo" varStatus="i">
				<dd class="clearboth">
				<div class="sbyxtul">
					<a href=""><img src="${commonInfo.img_url}" width="109" height="144" alt="" /></a>
				</div>
				<div class="sbyxtur">
					...
					<div class="clearboth"><a href="" class="viewxq">查看详情</a></div>
				</div>
			</dd>
			</c:forEach>
		</dl>
