...
<head>
	...
	<title>美娱美乐www.lecc.cc--二人世界--${commonInfo.name}</title>
...
<body>
		...
		<div class="bgwhite">
			...
			<c:forEach items="${commentList}" var="temp">
				<li>
					...
					<p class="juubao"><a href="javascript:void(0);"></a></p>
				</li>
			</c:forEach>
			</ul>
	...
	<div id="qgcontainer" class="qgcontainer">
		<div id="qgcontain">
			<div id="daohang">
				<a href="${pageContext.request.contextPath}/main.do?city_id=${commonInfo.city_id}">票友会</a> &gt; <a href="${pageContext.request.contextPath}/errenshijie-${param.city_id}">二人世界</a> &gt; ${commonInfo.name}
			</div>
			<div id="xqdetail">
					...
					<div id="xxcontain" class="clearboth">
						...
						<div id="xxcontainr">
							...
							<ul class="clearboth" id="shareto">
								<li>分享到：</li>
								<li><a class="sianwb" href="http://service.weibo.com/share/share.php?title=<%=myShowName %>&url=http://www.lecc.cc/errenshijie/commonInfoDetail.do?id=${commonInfo.id }&appkey=2268730460&pic=<%=pic%>" target="_blank">新浪微博</a></li>
								<li><a href="http://www.douban.com/recommend/?url=http://www.lecc.cc/errenshijie/commonInfoDetail.do?id=${commonInfo.id }&amp;title=<%=myShowName %>&image=<%=pic%>" target="_blank" class="doubans">豆瓣</a></li>
								<li><a href="http://v.t.qq.com/share/share.php?title=<%=myShowName %>&amp;url=http://www.lecc.cc/errenshijie/commonInfoDetail.do?id=${commonInfo.id }&amp;site=http://www.lecc.cc/&amp;pic=<%=pic%>" target="_blank" class="txwb">腾讯微博</a></li>
							</ul>
						</div>
					</div>
				...
				<div id="tgcontentr">
					...
					<ol id="bjtj">
						<c:forEach items="${recommendList}" var="commonInfo" varStatus="i">
							<li class="clearboth"><span class="numor">${i.index+1}</span><a href="${pageContext.request.contextPath}/errenshijie/${commonInfo.id}-${param.city_id}">${commonInfo.name }</a></li>
						</c:forEach>
					</ol>
				</div>
			</div>
