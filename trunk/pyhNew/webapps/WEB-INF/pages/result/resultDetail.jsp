...
<head>
	...
	<title>美娱美乐www.lecc.cc--${commonInfo.name }</title>
...
<div class="tanchuang">
	...
	<div class="tanchuang">
		<div class="bgwhite">
			...
			<form action="">
				...
				<div class="popin">
					<div class="popinl clearboth"><img src="${pageContext.request.contextPath}/public/images/face_smile.png" alt="" /><input type="checkbox" name="tshipl1" id="tshipl11" class="tshipl" /><label for="tshipl1">同时推荐到都在看</label></div>
					<div class="popinr">
						<div class="zishu clearboth">
							<div class="zisshu">还可以输入<span class="zinumber">500</span>字&nbsp;</div>
	...
	<div id="qgcontainer" class="qgcontainer">
		<div id="qgcontain">
			<div id="daohang">
				<a href="${pageContext.request.contextPath}/main.do?city_id=1">票友会</a> &gt; <a href="${pageContext.request.contextPath}/result/main.do?city_id_result=${commonInfo.city_id}&city_id=${param.city_id}">${commonInfo.city_name }</a> &gt; <a href="${pageContext.request.contextPath}/result/main.do?city_id_result=${commonInfo.city_id}&show_type=${commonInfo.show_type}&city_id=${param.city_id}">${commonInfo.type_name }</a> &gt; ${commonInfo.name}
			</div>
			<div id="xqdetail">
				...
				<div id="tgcontentr">
					...
					<ol id="bjtj">
						<c:forEach items="${recommendList}" var="commonInfo" varStatus="i">
							<li class="clearboth"><span class="numor">${i.index+1}</span><a href="${pageContext.request.contextPath}/result/resultDetail.do?id=${commonInfo.id}">${commonInfo.name }</a></li>
						</c:forEach>
					</ol>
				</div>
			</div>
