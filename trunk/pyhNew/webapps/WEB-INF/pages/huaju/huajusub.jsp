...
<head>
	...
	<title>美娱美乐www.lecc.cc--话剧--${c.title }</title>
		...
		<div id="qgcontain">
			<dl id="qgsublist">
				...
				<c:forEach items="${list}" var="ci" varStatus="i">
					...
					<a class="qgsuba1" href="${pageContext.request.contextPath}/huaju/${ci.id}-${city_id}"><img src="${ci.img_url }" alt="${ci.name }" width="150px" height="200px"/></a>
					<div class="ctitlee"><a class="qgsuba2" href="${pageContext.request.contextPath}/huaju/${ci.id}-${city_id}" title="${ci.name }">
				...
				<div class="Pagination">
					 <jsp:include page="../pagenation_util.jsp">
		 				<jsp:param  name="url"   value="${pageContext.request.contextPath}/huaju-${c.id}-${param.city_id}"/>
	 				</jsp:include>
				</div>
		  </div>
