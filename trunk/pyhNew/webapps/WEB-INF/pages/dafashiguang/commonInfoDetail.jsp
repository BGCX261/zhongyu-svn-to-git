...
<head>
	...
	<title>美娱美乐www.lecc.cc--打发时光--${commonInfo.name}</title>
...
<body>
		...
		<div class="bgwhite">
			...
			<form action="" id="dingyue" class="tcform">
				<ul class="formitems"><!--
					...
					--><li class="btnsub"><a href="javascript:void(0);" class="btnsures">&nbsp;</a></li>
				</ul>
			</form>
		</div>
	</div>
	<div class="tanchuang">
		<div class="bgwhite">
			...
			<form action="">
				...
				<div class="popin">
					<div class="popinl clearboth"><img src="${pageContext.request.contextPath}/public/images/face_smile.png" alt="" />
					<input type="checkbox" name="tshipl" id="tshipl" class="tshipl" /><label for="tshipl">同时作为评论发布</label></div>
					<div class="popinr">
						<div class="zishu clearboth">
							<div class="zisshu">还可以输入<span class="zinumber">500</span>字&nbsp;</div>
							<div class="fshangq"><a href="javascript:void(0);" class="fashangql">发上去</a></div>
						</div>
					</div>
				</div>
			</form>
	...
	<div class="tanchuang">
		<div class="bgwhite">
			...
			<form action="">
				...
				<div class="popin">
					<div class="popinl clearboth"><img src="${pageContext.request.contextPath}/public/images/face_smile.png" alt="" />
					<input type="checkbox" name="tshipl1" id="tshipl1" class="tshipl" /><label for="tshipl1">同时推荐到都在看</label></div>
					<div class="popinr">
						<div class="zishu clearboth">
							<div class="zisshu">还可以输入<span class="zinumber">500</span>字&nbsp;</div>
			...
			<c:forEach items="${commentList}" var="temp">
				<li>
					<div class="gpinlun">
						...
						<div class="gpinlunr">
							<p>
								<a href="javascript:void(0);" class="bbgg">${temp.user_name}</a>：${fn:substring(temp.comment_info, 0, 50)}
							</p>
						</div>
					</div>
					<p class="juubao"><a href="javascript:void(0);">举报</a></p>
	...
	<div id="qgnavcon">
		<ul id="qinggannav" class="clearboth">
			...
			<li class="hssub">
			 ...
			 -->
			<li><a href="${pageContext.request.contextPath}/dafashiguang-${param.city_id}" class="yiji current"><span class="rbg"><span class="rbm">打发时光</span></span></a></li>
	...
	<div id="qgcontainer" class="qgcontainer">
		<div id="qgcontain">
			<div id="daohang">
				<a href="${pageContext.request.contextPath}/main.do?city_id=${commonInfo.city_id}">票友会</a>  &gt; <a href="${pageContext.request.contextPath}/dafashiguang-${param.city_id}">打发时光</a> &gt; ${commonInfo.name}
			</div>
			<div id="xqdetail">
				<h1>${commonInfo.name}</h1>
				<div id="jutixx">
					<div id="xxcontain" class="clearboth">
						<div id="xxcontainl"><a href="javascript:void(0);"><img src="${commonInfo.img_url}" width="277" height="373"  alt="${commonInfo.name}" /></a></div>
						<div id="xxcontainr">
							<div id="jiaggm">
							...
							<ul class="clearboth" id="shareto">
								<li>分享到：</li>
								<li><a class="sianwb" href="http://service.weibo.com/share/share.php?title=<%=myShowName %>&url=http://www.lecc.cc/dafashiguang/commonInfoDetail.do?id=${commonInfo.id }&appkey=2268730460&pic=<%=pic%>" target="_blank">新浪微博</a></li>
								<li><a href="http://www.douban.com/recommend/?url=http://www.lecc.cc/dafashiguang/commonInfoDetail.do?id=${commonInfo.id }&amp;title=<%=myShowName %>&image=<%=pic%>" target="_blank" class="doubans">豆瓣</a></li>
								<li><a href="http://v.t.qq.com/share/share.php?title=<%=myShowName %>&amp;url=http://www.lecc.cc/dafashiguang/commonInfoDetail.do?id=${commonInfo.id }&amp;site=http://www.lecc.cc/&amp;pic=<%=pic%>" target="_blank" class="txwb">腾讯微博</a></li>
							</ul>
						</div>
					</div>
			...
			<div id="tgcontent" class="clearboth">
				<div id="tgcontentl">
					...
					<ul id="ycxq">
						...
						<li class="othrs">演出场馆：<a href="javascript:void(0);" class="cgdz">${commonInfo.site_name}</a>  <a href="javascript:void(0);" onclick="showMessageBox(),map2();">[查看百度地图]</a></li>
					...
					<ul id="tbsmj" class="clearboth">
						...
						<li id="fbjp"><a href="javascript:void(0);" title="发布剧评">发布剧评</a></li>
					</ul>
				...
				<div id="tgcontentr">
					...
					<ol id="bjtj">
						<c:forEach items="${recommendList}" var="commonInfo" varStatus="i">
							<li class="clearboth"><span class="numor">${i.index+1}</span><a href="${pageContext.request.contextPath}/dafashiguang/${commonInfo.id}-${param.city_id}">${commonInfo.name }</a></li>
						</c:forEach>
					</ol>
				</div>
			</div>
