...
<head>
	...
	<title>美娱美乐www.lecc.cc--打发时光--首页</title>
			...
			<dl id="bt1" class="taopiaolist clearboth">
				<dt class="qingyem">
					...
					<!-- 
						...
						<a class="qgfl" href="">分类分类</a>
						 -->
						<a class="qgfl" href="${pageContext.request.contextPath}/dafashiguang-${benzhoujingpin_id}-${param.city_id}">查看更多</a>
					</span>
				</dt>
				<c:forEach items="${benzhoujingpinList}" var="commonInfo" varStatus="i">
					...
					<a href="${pageContext.request.contextPath}/dafashiguang/${commonInfo.id}-${param.city_id}" title="${commonInfo.name}"><img src="${commonInfo.heng_image_path}" width="290" height="173"  alt="${commonInfo.name}" /></a>
					<div class="tpdatesco">
						<div class="tpdates">
							<ul class="clearboth">
					...
					<div class="pjcon">
						...
						<a href="${pageContext.request.contextPath}/dafashiguang/${commonInfo.id}-${param.city_id}" class="qkk" title="去看看">去看看</a>
					</div>
				</dd>
				</c:forEach>
			</dl>
			<dl id="bt2" class="taopiaolist clearboth">
				<dt class="qingyem">
					...
					<!-- 
						...
						<a class="qgfl" href="">分类分类</a>
						 -->
						<a class="qgfl" href="${pageContext.request.contextPath}/dafashiguang-${jijiangshangyan_id}-${param.city_id}">查看更多</a>
					</span>
				</dt>
