...
<head>
	...
	<title>美娱美乐www.lecc.cc--儿童亲子--首页</title>
...
<body>
	...
	<div id="ychcontainer" class="qinzi">
		<div id="ychcontain">
			<div id="ychslide">
		...
		<c:forEach items="${listFocus}" var="fp">
			...
			<dl id="bt1" class="taopiaolist clearboth">
				<dt class="qingyem">
					...
					<span class="vmore">
						<a class="qgfl" href="${pageContext.request.contextPath}/ertongqinzi-1922-${param.city_id}">查看全部</a>
					</span>
				</dt>
					<c:forEach items="${jingpinList}" var="commonInfo" varStatus="i">
						<dd <c:if test="${i.index%3==2}">class="last"</c:if>>
					<!-- <h3>${commonInfo.sub_name}</h3> -->
					<a href="${pageContext.request.contextPath}/ertongqinzi/${commonInfo.id}-${param.city_id}" title="${commonInfo.name}"><img src="${commonInfo.heng_image_path}" width="290" height="173"  alt="${commonInfo.name}" /></a>
					<div class="tpdatesco">
						<div class="tpdates">
							<ul class="clearboth">
					...
					<div class="pjcon">
						...
						<a href="${pageContext.request.contextPath}/ertongqinzi/${commonInfo.id}-${param.city_id}" class="qkk" title="去看看">去看看</a>
					</div>
				</dd>
				</c:forEach>
			</dl>
			<dl id="bt2" class="taopiaolist clearboth">
				<dt class="qingyem">
					...
					<span class="vmore">
						<a class="qgfl" href="${pageContext.request.contextPath}/ertongqinzi-1923-${param.city_id}">查看全部</a>
					</span>
				</dt>
