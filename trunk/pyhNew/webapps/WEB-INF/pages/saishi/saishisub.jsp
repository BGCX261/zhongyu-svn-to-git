...
<head>
	...
	<title>美娱美乐www.lecc.cc--赛事--${c.title }</title>
		...
		<div id="qgcontain">
			<dl id="qgsublist">
				...
				<c:forEach items="${list}" var="ci" varStatus="i">
					...
					<a class="qgsuba1" href="${pageContext.request.contextPath}/saishi/${ci.id}-${param.city_id}"><img src="${ci.img_url }" alt="${ci.name }" width="150px" height="200px"/></a>
			...
			<div class="page">
				<div class="Pagination">
					 <jsp:include page="../pagenation_util.jsp">
		 				<jsp:param name="url" value="${pageContext.request.contextPath}/saishi-${c.id}-${param.city_id}"/>
	 				</jsp:include>
				</div>
		  </div>
