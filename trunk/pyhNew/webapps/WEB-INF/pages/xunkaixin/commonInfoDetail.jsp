...
<head>
	...
	<title>美娱美乐www.lecc.cc--寻开心--${commonInfo.name}</title>
...
<body>
	...
	<div id="qgnavcon">
		<ul id="qinggannav" class="clearboth">
			...
			<li><a href="${pageContext.request.contextPath}/xunkaixin-${param.city_id}" class="yiji current"><span class="rbg"><span class="rbm">寻开心</span></span></a></li>
			<!-- 
			<li class="hssub">
				<a href="${pageContext.request.contextPath}/xunkaixin-${param.city_id}" class="yiji current"><span class="rbg"><span class="rbm">寻开心</span></span></a>
				<ul class="submenu">
		...
		<!-- <ul class="subnav subnavvis clearboth">
			<li><a href="${pageContext.request.contextPath}/xunkaixin-1789-${param.city_id}" <c:if test="${category.id=='1789'}">class="current"</c:if>>查看全部</a></li>
			<li><a href="${pageContext.request.contextPath}/xunkaixin-1841-${param.city_id}" <c:if test="${category.id=='1841'}">class="current"</c:if>>段子有的是</a></li>
			<li class="last"><a href="${pageContext.request.contextPath}/xunkaixin-1842-${param.city_id}" <c:if test="${category.id=='1842'}">class="current"</c:if>>开心喜剧</a></li>
		</ul>
		 -->
	</div>
	<div id="qgcontainer" class="qgcontainer">
		<div id="qgcontain">
			<div id="daohang">
				<a href="${pageContext.request.contextPath}/main.do?city_id=${param.city_id}">票友会</a> &gt; <a href="${pageContext.request.contextPath}/xunkaixin-${param.city_id}">寻开心</a> &gt; ${commonInfo.name}
			</div>
			<div id="xqdetail">
					...
					<div id="xxcontain" class="clearboth">
						...
						<div id="xxcontainr">
							...
							<ul class="clearboth" id="shareto">
								<li>分享到：</li>
								<li><a class="sianwb" href="http://service.weibo.com/share/share.php?title=<%=myShowName %>&url=http://www.lecc.cc/xunkaixin/${commonInfo.id}-${param.city_id}&appkey=2268730460&pic=<%=pic%>" target="_blank">新浪微博</a></li>
								<li><a href="http://www.douban.com/recommend/?url=http://www.lecc.cc/xunkaixin/${commonInfo.id}-${param.city_id}&amp;title=<%=myShowName %>&image=<%=pic%>" target="_blank" class="doubans">豆瓣</a></li>
								<li><a href="http://v.t.qq.com/share/share.php?title=<%=myShowName %>&amp;url=http://www.lecc.cc/xunkaixin/${commonInfo.id}-${param.city_id}&amp;site=http://www.lecc.cc/&amp;pic=<%=pic%>" target="_blank" class="txwb">腾讯微博</a></li>
							</ul>
						</div>
					</div>
				...
				<div id="tgcontentr">
					...
					<ol id="bjtj">
						<c:forEach items="${recommendList}" var="commonInfo" varStatus="i">
							<li class="clearboth"><span class="numor">${i.index+1}</span><a href="${pageContext.request.contextPath}/xunkaixin/${commonInfo.id}-${param.city_id}">${commonInfo.name }</a></li>
						</c:forEach>
					</ol>
				</div>
			</div>
