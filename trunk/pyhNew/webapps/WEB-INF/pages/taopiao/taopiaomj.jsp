<%@ page language="java" contentType="text/html; charset=UTF-8" import="java.util.*,com.piaoyou.domain.*" pageEncoding="UTF-8" import="com.piaoyou.util.*;"%>
...
<head>
	...
	<title>美娱美乐www.lecc.cc--淘票末级页面</title>
...
<div class="tanchuang">
	...
	<div class="tanchuang">
		<div class="bgwhite">
			...
			<form action="">
				...
				<div class="popin">
					<div class="popinl clearboth"><img src="${pageContext.request.contextPath}/public/images/face_smile.png" alt="" /><input type="checkbox" name="tshipl" id="tshipl1" class="tshipl" /><label for="tshipl">同时推荐到都在看</label></div>
					<div class="popinr">
						<div class="zishu clearboth">
							<div class="zisshu">还可以输入<span class="zinumber">500</span>字&nbsp;</div>
	...
	<div id="tpnavs">
		<div id="tpnavscon">
			<h1 id="tplogo"><a href="${pageContext.request.contextPath}/taopiao-${param.city_id}" title="淘票精彩">淘票精彩</a></h1>
			<ul id="tpnavl" class="clearboth">
			<li><a class="h" href="${pageContext.request.contextPath}/taopiao/main.do">首页</a></li>
				<li class="gpdli"><a class="gpd gpdcurrent" href="${pageContext.request.contextPath}/taopiao/taopiaoChannel.do">逛频道</a>
					<div class="gpdsub">
						...
						<a href="${pageContext.request.contextPath}/taopiao-c-1804-${param.city_id}">亲子</a>
						<a href="${pageContext.request.contextPath}/taopiao-c-1805-${param.city_id}">电影</a>
					</div>
				</li>
	...
	<div id="tpcontain">
		<div id="tpcontain">
			<ul id="navqh" class="clearboth">
				<li><a href="${pageContext.request.contextPath}/taopiao-c-<%=Const.TAOPIAO_HUAJU_ID%>-${param.city_id}"  <c:if test="${commonInfo.category.id=='1799'}">class="dangq"</c:if>>话剧</a></li>
				<li><a href="${pageContext.request.contextPath}/taopiao-c-<%=Const.TAOPIAO_YANCHANGHUI_ID%>-${param.city_id}" <c:if test="${commonInfo.category.id=='1800'}">class="dangq"</c:if>>演唱会</a></li>
				<li><a href="${pageContext.request.contextPath}/taopiao-c-<%=Const.TAOPIAO_GUDIAN_ID%>-${param.city_id}" <c:if test="${commonInfo.category.id=='1801'}">class="dangq"</c:if>>古典</a></li>
				<li><a href="${pageContext.request.contextPath}/taopiao-c-<%=Const.TAOPIAO_YAOGUN_ID%>-${param.city_id}" <c:if test="${commonInfo.category.id=='1802'}">class="dangq"</c:if>>摇滚乐</a></li>
				<li><a href="${pageContext.request.contextPath}/taopiao-c-<%=Const.TAOPIAO_XIJU_ID%>-${param.city_id}" <c:if test="${commonInfo.category.id=='1803'}">class="dangq"</c:if>>戏剧/曲艺</a></li>
				<li><a href="${pageContext.request.contextPath}/taopiao-c-<%=Const.TAOPIAO_SAISHI_ID%>-${param.city_id}" <c:if test="${commonInfo.category.id=='1804'}">class="dangq"</c:if>>赛事</a></li>
				<li><a href="${pageContext.request.contextPath}/taopiao-c-<%=Const.TAOPIAO_QINZI_ID%>-${param.city_id}" <c:if test="${commonInfo.category.id=='1805'}">class="dangq"</c:if>>亲子</a></li>
				<li><a href="${pageContext.request.contextPath}/taopiao-c-<%=Const.TAOPIAO_DIANYING_ID%>-${param.city_id}" <c:if test="${commonInfo.category.id=='1806'}">class="dangq"</c:if>>电影</a></li>
			</ul>
		<div id="navlink">
			<p><a href="">淘票首页</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/taopiao-c-${commonInfo.category.id}-${param.city_id}">${commonInfo.category.title}频道</a>&nbsp;&nbsp;&gt;&nbsp;&nbsp;${commonInfo.name}</p>
		</div>
	</div>
	</div>
					...
					<div id="xxcontain" class="clearboth">
						...
						<div id="xxcontainr">
							...
							<li><a href="javascript:void(0);" class="tpmjymm tj">推荐</a></li>
								...
								<li><a href="javascript:void(0);" class="tpmjymm sc">收藏</a></li>
							</ul>
							<ul class="clearboth" id="shareto">
								<li>分享到：</li>
								<li><a class="sianwb" href="http://service.weibo.com/share/share.php?title=<%=myShowName %>&url=http://www.lecc.cc/taopiao/${commonInfo.id}-${param.city_id}&appkey=2268730460&pic=<%=pic%>" target="_blank">新浪微博</a></li>
								<li><a href="http://www.douban.com/recommend/?url=http://www.lecc.cc/taopiao/${commonInfo.id}-${param.city_id}&amp;title=<%=myShowName %>&image=<%=pic%>" target="_blank" class="doubans">豆瓣</a></li>
								<li><a href="http://v.t.qq.com/share/share.php?title=<%=myShowName %>&amp;url=http://www.lecc.cc/taopiao/${commonInfo.id}-${param.city_id}&amp;site=http://www.lecc.cc/&amp;pic=<%=pic%>" target="_blank" class="txwb">腾讯微博</a></li>
							</ul>
						</div>
					</div>
					<!-- 
			...
			<div id="tgcontent" class="clearboth">
				<div id="tgcontentl">
					...
					<ul id="ycxq">
						...
						<li class="othrs">演出时间：${commonInfo.year }年${commonInfo.month }月${commonInfo.day }日 ${commonInfo.show_time }</li>
					...
					<div id="pubp2">
						<div id="zstj" class="clearboth">
							...
							<textarea name="" id="textareapl" cols="30" rows="10">在这里写下你的短评吧…</textarea>
							<div id="subdata">
								<div id="facei"><img src="${pageContext.request.contextPath}/public/images/iconface2.png" alt="" /> 表情</div>
								<div id="zishutq">还可以输入<span class="leizt">140</span>字</div>
								<button id="fsq"></button>
							</div>
					</div>
					<ul id="tbsmj" class="clearboth">
						<li><a href="javascript:void(0);" id="recommendRemark">推荐剧评</a></li>
						<li><a href="javascript:void(0);" id="newRemark">最新剧评</a></li>
				...
				<div id="tgcontentr">
					...
					<c:forEach items="${recommendList}" var="commonInfo" varStatus="i">
							<li class="clearboth"><span class="numor">${i.index+1}</span><a href="${pageContext.request.contextPath}/taopiao/${commonInfo.id}-${param.city_id}">${commonInfo.name }</a></li>
						</c:forEach>
					</ol>
				</div>
			</div>
