...
public class TaopiaoServiceImpl implements TaopiaoService {
	...
	@Override
	public List<CommonInfo> getCommonInfoList(int categoryId, String cityId,String pageIndex, String pageCount) {
		Map<Object,Object> params = new HashMap<Object,Object>();
	...
	@Override
	public List<CommonInfo> getGroupList(int categoryId, String cityId,String pageIndex, String pageCount) {
		Map<Object,Object> params = new HashMap<Object,Object>();
		params = new HashMap<Object,Object>();
		params.put("category_id", categoryId);
		params.put("city_id", cityId);
	...
	public String getCommonTotalCount(int categoryId, String cityId) {
		...
		params.put("city_id", cityId);
		params.put("category_id", categoryId);
		totalCount = commonDao.selectObject("taopiao.getCommonTotalCount", params);
		return totalCount;
	}
	@Override
	...
	public CommonInfo getGroupDetail(int common_id) {
		...
		params.put("id", common_id);
		//获取演出基本信息
		CommonInfo commonInfo = commonDao.selectObject("commonInfo.getGroupDetail", params);
		//获取演出时间
		 Map<Object,Object> timeMap = this.getCommonInfoTimeMap();
		 CommonInfo time = (CommonInfo)timeMap.get(common_id+"");
		 String show_time = time.getShow_time();
