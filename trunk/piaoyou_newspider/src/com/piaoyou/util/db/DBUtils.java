...
public final class DBUtils {
	...
	private static void initDataSource() {
		try {
			bds.setDriverClassName("com.mysql.jdbc.Driver"); // 数据库驱动程序
			bds.setUrl("jdbc:mysql://192.168.1.251/piaoyou_new?autoReconnect=true&amp;characterEncoding=utf8"); // 数据库url
			bds.setUsername("root"); // dba帐号
			bds.setPassword("123456"); // 密码
			bds.setMaxActive(120); // 初始化连接数量
			bds.setMaxIdle(80); // 最大idle数
			bds.setMaxWait(60000); // 超时回收时间
