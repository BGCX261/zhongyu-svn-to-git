package com.piaoyou.crawler.spe;
...
import com.piaoyou.crawler.spider.Piao321Spider;
...
public class JingdongSpider extends TicketSpider implements SpiderTask {
	...
	public void processLastPage(String url,String name,int sortType,Map<String,Show> map){
		...
		if (map.keySet().contains(name)) {
			...
			Element info = PubFun.cleanElement(doc.select("#i-detail>div.content>div>div>div>div").first());
			if (null == info) {
