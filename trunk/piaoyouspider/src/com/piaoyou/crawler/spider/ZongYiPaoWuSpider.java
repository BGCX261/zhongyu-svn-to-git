...
public class ZongYiPaoWuSpider extends TicketSpider implements SpiderTask {
	private static Log log=LogFactory.getLog(ZongYiPaoWuSpider.class);
	@Override
	public void extract() {
		...
		while(ulEleList.hasNext()){
			...
			while(priceEleList.hasNext()){
				...
				if("de054".equals(priceEle.attr("class").trim())){
					...
					remark="有票";
					isExists=true;
					ticket.setDetailURL("http://www.zypw.com/cart.aspx");
				}
	...
	public static void main(String[] args) {
		ZongYiPaoWuSpider Spider = new ZongYiPaoWuSpider();
